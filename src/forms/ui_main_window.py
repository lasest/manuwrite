...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.EdtiorPage)
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.MainEditor.sizePolicy().hasHeightForWidth())
        self.MainEditor.setSizePolicy(sizePolicy)
        self.MainEditor.setObjectName("MainEditor")
        self.verticalLayout_2.addWidget(self.MainEditor)
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.ProjectPage)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.ProjectSettingsLabel = QtWidgets.QLabel(self.ProjectPage)
        self.ProjectSettingsLabel.setAlignment(QtCore.Qt.AlignCenter)
        self.ProjectSettingsLabel.setObjectName("ProjectSettingsLabel")
        self.verticalLayout_5.addWidget(self.ProjectSettingsLabel)
        self.ProjectSettingsTableWidget = QtWidgets.QTableWidget(self.ProjectPage)
        self.ProjectSettingsTableWidget.setObjectName("ProjectSettingsTableWidget")
        self.ProjectSettingsTableWidget.setColumnCount(0)
        self.ProjectSettingsTableWidget.setRowCount(0)
        self.verticalLayout_5.addWidget(self.ProjectSettingsTableWidget)
        self.ProjectSettingsButtonLayout = QtWidgets.QHBoxLayout()
        self.ProjectSettingsButtonLayout.setObjectName("ProjectSettingsButtonLayout")
        self.SaveProjectSettingsButton = QtWidgets.QPushButton(self.ProjectPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Maximum, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.SaveProjectSettingsButton.sizePolicy().hasHeightForWidth())
        self.SaveProjectSettingsButton.setSizePolicy(sizePolicy)
        self.SaveProjectSettingsButton.setObjectName("SaveProjectSettingsButton")
        self.ProjectSettingsButtonLayout.addWidget(self.SaveProjectSettingsButton)
        self.verticalLayout_5.addLayout(self.ProjectSettingsButtonLayout)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ProjectSettingsLabel.setText(_translate("MainWindow", "Project settings"))
        self.SaveProjectSettingsButton.setText(_translate("MainWindow", "Save changes"))
        ...
        self.actionProjectTab.setShortcut(_translate("MainWindow", "Ctrl+P"))
