...
class Ui_SettingsDialog(object):
    def setupUi(self, SettingsDialog):
        ...
        self.verticalLayout_9 = QtWidgets.QVBoxLayout(self.GeneralTab)
        self.verticalLayout_9.setObjectName("verticalLayout_9")
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.ParsingIntervalLabel = QtWidgets.QLabel(self.GeneralTab)
        self.ParsingIntervalLabel.setObjectName("ParsingIntervalLabel")
        self.horizontalLayout_2.addWidget(self.ParsingIntervalLabel)
        self.ParsingIntervalSpinBox = QtWidgets.QSpinBox(self.GeneralTab)
        self.ParsingIntervalSpinBox.setMinimum(100)
        self.ParsingIntervalSpinBox.setMaximum(10000)
        self.ParsingIntervalSpinBox.setObjectName("ParsingIntervalSpinBox")
        self.horizontalLayout_2.addWidget(self.ParsingIntervalSpinBox)
        self.verticalLayout_9.addLayout(self.horizontalLayout_2)
        self.ParsingIntervalCommentLabel = QtWidgets.QLabel(self.GeneralTab)
        self.ParsingIntervalCommentLabel.setWordWrap(True)
        self.ParsingIntervalCommentLabel.setObjectName("ParsingIntervalCommentLabel")
        self.verticalLayout_9.addWidget(self.ParsingIntervalCommentLabel)
        ...
        self.FontSizeLayout.addItem(spacerItem2)
        ...
        self.DefaultImageSizeLayout.addItem(spacerItem3)
        ...
        self.ImageToolTipLayout.addItem(spacerItem4)
        ...
        self.IconsLayout.addItem(spacerItem8)
        ...
        self.ColorSchemaLayout.addItem(spacerItem9)
        ...
        self.ExportCssButton.setEnabled(False)
        ...
        self.DeleteCssButton.setEnabled(False)
        ...
        self.ExportCslButton.setEnabled(False)
        ...
        self.DeleteCslButton.setEnabled(False)
        ...
        self.GetMoreCslStylesLabel = QtWidgets.QLabel(self.CslStylesGroupBox)
        self.GetMoreCslStylesLabel.setTextInteractionFlags(QtCore.Qt.LinksAccessibleByKeyboard|QtCore.Qt.LinksAccessibleByMouse)
        self.GetMoreCslStylesLabel.setObjectName("GetMoreCslStylesLabel")
        self.verticalLayout_8.addWidget(self.GetMoreCslStylesLabel)
    ...
    def retranslateUi(self, SettingsDialog):
        ...
        self.ParsingIntervalLabel.setText(_translate("SettingsDialog", "Document parsing interval (ms)"))
        self.ParsingIntervalCommentLabel.setText(_translate("SettingsDialog", "Defines how often document structure would be parsed. Set to 0 to disable parsing of document structure."))
        ...
        self.GetMoreCslStylesLabel.setText(_translate("SettingsDialog", "<a href=\"https://www.zotero.org/styles\">Get more styles...</a>"))
