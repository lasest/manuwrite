...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ProjectTabLabel.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.FootnoteToolButton = QtWidgets.QToolButton(self.frame)
        ...
        self.AddCitationToolButton.setText("")
        ...
        self.RenderFileToolButton.setText("")
        self.RenderFileToolButton.setObjectName("RenderFileToolButton")
        self.horizontalLayout_5.addWidget(self.RenderFileToolButton)
        self.RenderProjectToolButton = QtWidgets.QToolButton(self.frame)
        self.RenderProjectToolButton.setText("")
        self.RenderProjectToolButton.setObjectName("RenderProjectToolButton")
        self.horizontalLayout_5.addWidget(self.RenderProjectToolButton)
        ...
        self.ProjectTabWidget = QtWidgets.QTabWidget(self.ProjectWidget)
        self.ProjectTabWidget.setObjectName("ProjectTabWidget")
        self.ProjectFilesTab = QtWidgets.QWidget()
        self.ProjectFilesTab.setObjectName("ProjectFilesTab")
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.ProjectFilesTab)
        self.verticalLayout_5.setObjectName("verticalLayout_5")
        self.ProjectTreeView = QtWidgets.QTreeView(self.ProjectFilesTab)
        ...
        self.verticalLayout_5.addWidget(self.ProjectTreeView)
        self.ProjectTabWidget.addTab(self.ProjectFilesTab, "")
        self.ProjectStructureTab = QtWidgets.QWidget()
        self.ProjectStructureTab.setObjectName("ProjectStructureTab")
        self.verticalLayout_7 = QtWidgets.QVBoxLayout(self.ProjectStructureTab)
        self.verticalLayout_7.setObjectName("verticalLayout_7")
        self.ProjectStrucutreCombobox = QtWidgets.QComboBox(self.ProjectStructureTab)
        self.ProjectStrucutreCombobox.setObjectName("ProjectStrucutreCombobox")
        self.ProjectStrucutreCombobox.addItem("")
        self.ProjectStrucutreCombobox.addItem("")
        self.verticalLayout_7.addWidget(self.ProjectStrucutreCombobox)
        self.ProjectStructureTreeWidget = QtWidgets.QTreeWidget(self.ProjectStructureTab)
        self.ProjectStructureTreeWidget.setLineWidth(1)
        self.ProjectStructureTreeWidget.setEditTriggers(QtWidgets.QAbstractItemView.NoEditTriggers)
        self.ProjectStructureTreeWidget.setProperty("showDropIndicator", False)
        self.ProjectStructureTreeWidget.setIconSize(QtCore.QSize(16, 16))
        self.ProjectStructureTreeWidget.setIndentation(10)
        self.ProjectStructureTreeWidget.setHeaderHidden(False)
        self.ProjectStructureTreeWidget.setColumnCount(4)
        self.ProjectStructureTreeWidget.setObjectName("ProjectStructureTreeWidget")
        self.ProjectStructureTreeWidget.headerItem().setText(0, "1")
        self.ProjectStructureTreeWidget.headerItem().setText(1, "2")
        self.ProjectStructureTreeWidget.headerItem().setText(2, "3")
        self.ProjectStructureTreeWidget.headerItem().setText(3, "4")
        self.ProjectStructureTreeWidget.header().setVisible(False)
        self.verticalLayout_7.addWidget(self.ProjectStructureTreeWidget)
        self.ProjectTabWidget.addTab(self.ProjectStructureTab, "")
        self.verticalLayout_4.addWidget(self.ProjectTabWidget)
        ...
        self.menuBar.setGeometry(QtCore.QRect(0, 0, 1218, 35))
        ...
        self.actionRenderProject = QtWidgets.QAction(MainWindow)
        self.actionRenderProject.setObjectName("actionRenderProject")
        ...
        self.ProjectTabWidget.setCurrentIndex(1)
        self.ProjectStrucutreCombobox.setCurrentIndex(0)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.ProjectTabWidget.setTabText(self.ProjectTabWidget.indexOf(self.ProjectFilesTab), _translate("MainWindow", "Project"))
        self.ProjectStrucutreCombobox.setItemText(0, _translate("MainWindow", "Current file"))
        self.ProjectStrucutreCombobox.setItemText(1, _translate("MainWindow", "Current project (files to render)"))
        self.ProjectTabWidget.setTabText(self.ProjectTabWidget.indexOf(self.ProjectStructureTab), _translate("MainWindow", "Strucutre"))
        ...
        self.actionBoldItalic.setText(_translate("MainWindow", "Bold and italic"))
        self.actionBoldItalic.setToolTip(_translate("MainWindow", "Bold and italic"))
        self.actionBoldItalic.setShortcut(_translate("MainWindow", "Ctrl+Shift+B"))
        self.actionHeading1.setText(_translate("MainWindow", "Heading 1"))
        self.actionHeading1.setToolTip(_translate("MainWindow", "Level 1 heading"))
        self.actionHeading1.setShortcut(_translate("MainWindow", "Ctrl+H, H"))
        self.actionHeading2.setText(_translate("MainWindow", "Heading 2"))
        self.actionHeading2.setToolTip(_translate("MainWindow", "Level 2 heading"))
        self.actionHeading2.setShortcut(_translate("MainWindow", "Ctrl+H, Ctrl+H"))
        self.actionHeading3.setText(_translate("MainWindow", "Heading 3"))
        self.actionHeading3.setToolTip(_translate("MainWindow", "Level 3 heading"))
        self.actionHeading3.setShortcut(_translate("MainWindow", "Ctrl+3"))
        self.actionHeading4.setText(_translate("MainWindow", "Heading 4"))
        self.actionHeading4.setToolTip(_translate("MainWindow", "Level 4 heading"))
        self.actionHeading4.setShortcut(_translate("MainWindow", "Ctrl+4"))
        self.actionHeading5.setText(_translate("MainWindow", "Heading 5"))
        self.actionHeading5.setToolTip(_translate("MainWindow", "Level 5 heading"))
        self.actionHeading5.setShortcut(_translate("MainWindow", "Ctrl+5"))
        self.actionHeading6.setText(_translate("MainWindow", "Heading 6"))
        self.actionHeading6.setToolTip(_translate("MainWindow", "Level 6 heading"))
        self.actionHeading6.setShortcut(_translate("MainWindow", "Ctrl+6"))
        self.actionHorizontalRule.setText(_translate("MainWindow", "Horizontal rule"))
        self.actionHorizontalRule.setToolTip(_translate("MainWindow", "Horizontal rule"))
        self.actionBlockquote.setText(_translate("MainWindow", "Blockquote"))
        self.actionOrdList.setText(_translate("MainWindow", "Ordered list"))
        self.actionOrdList.setToolTip(_translate("MainWindow", "Ordered list"))
        self.actionOrdList.setShortcut(_translate("MainWindow", "F12"))
        self.actionUnordList.setText(_translate("MainWindow", "Unordered list"))
        self.actionUnordList.setToolTip(_translate("MainWindow", "Unordered list"))
